...
{
    internal class ProgramVocalEffectsManager : IProgramVocalEffectsManager
    {
        /// <summary>
        ///     Vocal Effects offset address
        /// </summary>
        private static readonly byte[] AddressOffset = {0x18, 0x00, 0x01, 0x00};
